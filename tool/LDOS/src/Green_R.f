...
c     real version
      real(knd)    :: a(:), b(:), yr(:,:,:), alpha_m2, beta_m2
...
c        LDOS calculation Compatible to Takayama
            ...
            call apply_cg(ND,CGSTEP,eref,b,v,alpha,beta,
