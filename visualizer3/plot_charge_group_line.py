...
if __name__ == "__main__":
    ...
    charges = []
    time = [f["t"]*kPsecPerAu for f in charge_group["charges_on_groups_all"]]
    for i in range(charge_group["num_groups"]) :
        charge = [f["ch"][i] for f in charge_group["charges_on_groups_all"]]
