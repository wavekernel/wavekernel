...
!          module procedure append_to_string_c, append_to_string_s ! Mizuho-IR
          module procedure append_to_string_s ! Mizuho-IR
      end interface
...
!!$      public :: operator(//)
      public :: operator(==) ! Mizuho-IR
! Mizuho-IR
!!$      public :: operator(==),operator(/=) ! Mizuho-IR
!!$      public :: operator(<),operator(<=)
!!$      public :: operator(>),operator(>=)
!!$      public :: llt,lle,lge,lgt
!!$      public :: char,len,len_trim,trim,iachar,ichar,adjustl,adjustr
      public :: char,len_trim,trim ! Mizuho-IR
! Mizuho-IR
...
!      elemental function string_size(s) ! Mizuho-IR
      function string_size(s) ! Mizuho-IR
...
!      pure function s_to_c(s) ! Mizuho-IR
      function s_to_c(s) ! Mizuho-IR
      ...
      do i=1, len(s)  ! Mizuho-IR
         s_to_c(i:i) = s%chars(i)
      end do

!      s_to_c = transfer(s%chars(1:len(s)),s_to_c)  ! Mizuho-IR
...
!      elemental subroutine assign_s_to_s(var,expr) ! Mizuho-IR
      subroutine assign_s_to_s(var,expr) ! Mizuho-IR
...
!      elemental subroutine assign_s_to_c(var,expr) ! Mizuho-IR
      subroutine assign_s_to_c(var,expr) ! Mizuho-IR
      ...
      !      var(1:ls) = transfer(expr%chars(1:ls),var(1:ls)) ! Mizuho-IR
...
!      elemental subroutine assign_c_to_s(var,expr) ! Mizuho-IR
      subroutine assign_c_to_s(var,expr) ! Mizuho-IR
...
!      pure subroutine append_to_string_s(s1,s2) ! Mizuho-IR
      subroutine append_to_string_s(s1,s2) ! Mizuho-IR
...
!      elemental subroutine unstring(s) ! Mizuho-IR
      subroutine unstring(s) ! Mizuho-IR
...
!      pure function trim_s(s) ! Mizuho-IR
      function trim_s(s) ! Mizuho-IR
...
!      elemental function s_eq_s(s1,s2) ! Mizuho-IR
      function s_eq_s(s1,s2) ! Mizuho-IR
...
!      elemental function s_eq_c(s,c)  ! Mizuho-IR
      function s_eq_c(s,c) ! Mizuho-IR
...
!      elemental function c_eq_s(c,s) ! Mizuho-IR
      function c_eq_s(c,s) ! Mizuho-IR
